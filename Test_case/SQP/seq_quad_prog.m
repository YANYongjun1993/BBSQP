...
function [u_sqp,xtra,fval,it,ocp_res,time] = seq_quad_prog(xhat,km,itmax,tol,N,size_x,size_u,gamma)
...
%         epsilon = 0.0001;
%         qp.H = Hessian+epsilon*eye(15); % add an epsilon*identity to convert the Hessian matrix as positive semidefite
        qp.H = Hessian;
        ...
        [x,~,~,~,duals] = quadprog(qp.H,qp.f,qp.A,qp.b,qp.G,qp.h,[],[],[],options);
