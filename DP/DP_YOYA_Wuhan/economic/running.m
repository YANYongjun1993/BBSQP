...
alpha = 0.005;% 断油信号变化权重
[X_opt,Z_opt,fval,p,b,mf_sum,a,time_sum]= DP1(v0,v_max,v_min,v_ref,d,S,h,alpha);
save whecow0.7alpha0.005.mat
%% plot
figure
width=600;%宽度bai，像素数
height=400;%高度
...
subplot(3,2,5);
plot(1:10:(column)*10,a*180/3.12,'r','linewidth',2);
xlabel('Distance [m]','Fontname','Times New Roman','fontsize',16);
