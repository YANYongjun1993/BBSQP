...
% [size_C, size_Cbar]=generate_functions(size_x,size_u,x0);
load size_C;
load size_Cbar;
opt.itmax = 5; % maximum iteration of the SQP
...
yidx = true(N,1);
for i = 1:nsim-1
    [u_sqp,xtra,fval,it,res1(i),time(i)] = BandB(xsim(:,i),N,km,opt,yidx,size_x,size_u);
